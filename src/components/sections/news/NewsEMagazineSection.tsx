      ...
      {loading ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl p-4 shadow-sm flex flex-col sm:flex-row gap-4 animate-pulse"
            >
              <div className="w-full sm:w-56 md:w-72 aspect-[16/9] rounded-lg bg-gray-200" />
