...
const eventLabels: Record<ProjectLog["eventType"], string> = {
  created: "Tạo dự án",
  submitted: "Gửi duyệt",
  updated: "Cập nhật",
  published: "Xuất bản",
...
export function ProjectHistoryDialog({ projectId, isOpen, onClose }: ProjectHistoryDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 sm:p-8 overflow-hidden">
      ...
      >
        ...
        >
          <h3 className="text-base font-bold text-white">Lịch sử dự án</h3>
          <button
            type="button"
            onClick={onClose}
