...
export function HeroSection() {
  return (
    <section
      id="top"
      className="relative flex min-h-[110dvh] w-full flex-col items-center overflow-hidden text-center"
    >
      {/* Background */}
      <motion.div
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="relative z-10 mx-auto flex w-full max-w-5xl items-center justify-center gap-6 px-6 py-5 pt-8 sm:gap-10 sm:px-10 lg:gap-24 lg:px-16"
      >
      ...
      >
        <Image
          ...
          height={120}
          priority
          className="h-auto w-full max-w-[90%] sm:max-w-[700px] lg:max-w-[900px]"
        />
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.6, ease: "easeOut" }}
          className="mt-4 text-xl font-normal sm:text-3xl lg:text-4xl"
          style={{
