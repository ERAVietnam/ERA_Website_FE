    ...
    >
      <div className="max-w-[1180px] mx-auto">
        <div className="max-w-[940px] mx-auto mb-10 md:mb-11 text-center">
          ...
          >
            <span className="block mb-[0.6rem]">Một con đường đủ rộng</span>
            <span className="block">
              để thành <span style={{ color: c.red }}>cả một khu phố</span>
            </span>
          </h2>
          <p
        ...
        <div className="group overflow-hidden rounded-[22px]" style={{ boxShadow: "0 24px 60px rgba(0,0,0,0.18)" }}>
          <Image
            src="/landing/eco-retreat/02_img/rp-dai-lo-canhquan.webp"
        ...
        <div className="mt-6 bg-white rounded-[18px] p-4">
          <div className="group overflow-hidden rounded-[10px]">
            <Image
              src="/landing/eco-retreat/02_img/rung-phuong-ha-tang-mat-cat-dai-lo-01.webp"
